...
func _apply_responsive_layout() -> void:
	...
	ai_board_1.set_card_presentation(PlayerBoard.CARD_PRESENTATION_FULL)
	ai_board_3.set_card_presentation(PlayerBoard.CARD_PRESENTATION_FULL)
	ai_board_2.set_card_presentation(
		PlayerBoard.CARD_PRESENTATION_COMPACT
		if low_height else PlayerBoard.CARD_PRESENTATION_FULL
	)
