...
func test_player_board_scene_has_bounded_owned_cards_scroll() -> void:
	...
	assert_true(scene_text.contains("OwnedCardsColumn"))
	assert_true(scene_text.contains("type=\"HBoxContainer\" parent=\"BoardRoot/Layout/OwnedCardsScroll\""))
	assert_true(scene_text.contains("type=\"VBoxContainer\" parent=\"BoardRoot/Layout/OwnedCardsScroll\""))
	assert_true(scene_text.contains("CompactCardsColumn"))
