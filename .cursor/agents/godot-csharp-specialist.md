...
description: "Implements and reviews Godot 4 C# code. Use for .NET patterns, partial Godot classes, signals, exports, async behavior, typed node access, resources, or C# performance."
model: inherit
readonly: false
is_background: false
---
...
Implements and reviews Godot 4 C# code. Use for .NET patterns, partial Godot classes, signals, exports, async behavior, typed node access, resources, or C# performance.
...
- [ ] The result is complete for the requested Godot C# Specialist scope.
