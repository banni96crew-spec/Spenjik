...
description: "Implements Godot 4 native extensions. Use for GDExtension architecture, godot-cpp, godot-rust, native bindings, custom node types, build integration, or native performance hotspots."
model: inherit
readonly: false
is_background: false
---
...
Implements Godot 4 native extensions. Use for GDExtension architecture, godot-cpp, godot-rust, native bindings, custom node types, build integration, or native performance hotspots.
...
- [ ] The result is complete for the requested Godot GDExtension Specialist scope.
