...
**Цель:**  Создать заготовку теста в GUT со структурой «happy path» и «failed validation», чтобы обеспечить покрытие требований из тестового плана и правил мутации состояния.
