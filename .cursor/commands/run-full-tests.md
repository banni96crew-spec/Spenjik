...
2. Запусти полный набор тестов:
   ...
   - **Windows/PowerShell:**
     ...
     ```
3. Дождись завершения тестов и зафиксируй результат. Код возврата `0` означает, что все тесты прошли, `1` — существуют ошибки:contentReference[oaicite:20]{index=20}.
