# Specialist Coordination and Delegation Map
...
| producer | Any specialist role (role assignment within their domain only) |
...
2. [All assigned specialist roles]       -- Execute assigned tasks
...
6. producer           -- Sprint retrospective with post-sprint retrospective workflow
...
- Relevant specialist roles depending on the change
...
1. **Bypassing the hierarchy**: A specialist role should never make decisions
...
4. **Monolithic tasks**: Every task assigned to a specialist role should be completable
