...
description: >-
  Quality review of test files and manual evidence documents. Goes beyond existence checks — evaluates
  assertion coverage, edge case handling, naming conventions, and evidence completeness. Produces
  ADEQUATEINCOMPLETEMISSING verdict per story. Use before QA sign-off or on demand.
---
...
- Treat user-provided arguments as: `[story-path | sprint | system-name]`.
