...
name: bug-triage
description: >-
  Read all open bugs in productionqabugs/, re-evaluate priority vs. severity, assign to sprints,
  surface systemic trends, and produce a triage report. Use at sprint start or when the bug count
  grows enough to need re-prioritization.
---
...
- Treat user-provided arguments as: `[sprint | full | trend]`.
