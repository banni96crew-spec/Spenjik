...
name: retrospective
description: >-
  Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and
...
- Treat user-provided arguments as: `[sprint-N|milestone-name]`.
...
If a matching file is found, Ask the user:
...
Then Ask the user to present two options:
