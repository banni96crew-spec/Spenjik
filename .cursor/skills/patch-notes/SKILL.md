...
name: patch-notes
description: >-
  Generate player-facing patch notes from git history, sprint data, and internal changelogs.
  Translates developer language into clear, engaging player communication.
---
...
- Treat user-provided arguments as: `[version] [--style brief|detailed|full]`.
