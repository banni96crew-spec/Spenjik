...
name: perf-profile
description: >-
  Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and
  generates optimization recommendations with priority rankings.
---
...
- Treat user-provided arguments as: `[system-name or 'full']`.
...
Check for existing performance targets in design docs or .cursor/rules/:
