...
name: onboard
description: >-
  Generates a contextual onboarding document for a new contributor or agent joining the project.
  Summarizes project state, architecture, conventions, and current priorities relevant to the
  specified role or area.
---
...
- Treat user-provided arguments as: `[role|area]`.


## Phase 1: Load Project Context

Read .cursor/rules/ for project overview and standards.
...
[Summary of conventions relevant to this role from .cursor/rules/ and agent definition]
