...
name: team-polish
description: >-
  Orchestrate the polish team: coordinates performance-analyst, technical-artist, sound-designer, and
  qa-tester to optimize, polish, and harden a feature or area for release quality.
---
...
- Treat user-provided arguments as: `[feature or area to polish] [--review full|lean|solo]`.
...
Always provide full context in each agent's prompt (target feature/area, performance budgets, known issues). Run independent specialist passes in parallel where the pipeline allows it (e.g., Phases 3 and 4 can run simultaneously).
