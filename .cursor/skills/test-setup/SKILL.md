...
name: test-setup
description: >-
  Scaffold the test framework and CICD pipeline for the project's engine. Creates the tests/ directory
  structure, engine-specific test runner configuration, and GitHub Actions workflow. Use once during
...
- Treat user-provided arguments as: `[force]`.
