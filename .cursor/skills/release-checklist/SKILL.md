...
description: >-
  Generates a comprehensive pre-release validation checklist covering build verification,
...
- Read `.cursor/rules/` for project context, version information, and platform targets.
