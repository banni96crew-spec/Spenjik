...
name: security-audit
description: >-
  Audit the game for security vulnerabilities: save tampering, cheat vectors, network exploits, data
  exposure, and input validation gaps. Produces a prioritised security report with remediation
  guidance. Use before any public release or multiplayer launch.
---
...
- Treat user-provided arguments as: `[full | network | save | input | quick]`.
...
Spawn `security-engineer` as a specialist review pass. Pass:
