...
description: >-
  Generates a comprehensive milestone progress review including feature completeness, quality metrics,
  risk assessment, and gono-go recommendation. Use at milestone checkpoints or when evaluating
...
- Treat user-provided arguments as: `[milestone-name|current] [--review full|lean|solo]`.
...
Before generating the Go/No-Go recommendation, spawn `producer` as a specialist review pass using gate **PR-MILESTONE** (`.cursor/docs/director-gates.md`).
...
If OFF TRACK, Ask the user before generating the recommendation:
