...
name: code-review
description: >-
  Performs an architectural and quality code review on a specified file or set of files. Checks for
  coding standard compliance, architectural pattern adherence, SOLID principles, testability, and
...
- Treat user-provided arguments as: `[path-to-file-or-directory]`.


## Phase 1: Load Target Files

Read the target file(s) in full. Read .cursor/rules/ for project coding standards.
...
Spawn all applicable specialists simultaneously as a specialist review pass — do not wait for one before starting the next.
...
For Logic and Integration stories, also spawn `qa-tester` as a specialist review pass in parallel with the engine specialists. Pass:
