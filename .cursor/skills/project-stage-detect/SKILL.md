...
description: >-
  Automatically analyze project state, detect stage, identify gaps, and recommend next steps based on
  existing artifacts. Use when user asks 'where are we in development', 'what stage are we in', 'full
  project audit'.
---
...
- Treat user-provided arguments as: `[optional: role filter like 'programmer' or 'designer']`.
