...
name: bug-report
description: >-
  Creates a structured bug report from a description, or analyzes code to identify potential bugs.
  Ensures every bug report has full reproduction steps, severity assessment, and context.
---
...
- Treat user-provided arguments as: `[description] | analyze [path-to-file]`.
