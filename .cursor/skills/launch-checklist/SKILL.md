...
description: >-
  Use before release to validate launch readiness across code, content, store, marketing, community,
  infrastructure, legal, and go/no-go sign-offs.
---
...
- Treat user-provided arguments as: `[launch-date or 'dry-run']`.
...
- Read `.cursor/rules/` for tech stack, target platforms, and team structure
