...
name: tech-debt
description: >-
  Track, categorize, and prioritize technical debt across the codebase. Scans for debt indicators,
  maintains a debt register, and recommends repayment scheduling.
---
...
- Treat user-provided arguments as: `[scan|add|prioritize|report]`.
...
Then Ask the user to collect the **category**:
...
Then Ask the user to collect the **estimated fix effort**:
