...
name: team-ui
description: >-
  Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design,
  implementation, review, and polish. Integrates with ux-design, ux-review, and studio UX templates.
---
...
- Treat user-provided arguments as: `[UI feature description] [--review full|lean|solo]`.
...
delegated to specialist review passes and sub-skills (`/ux-design`, `ui-programmer`). Each enforces the
