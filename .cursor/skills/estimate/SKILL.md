...
name: estimate
description: >-
  Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors.
  Produces a structured estimate with confidence levels.
---
...
- Treat user-provided arguments as: `[task-description]`.
...
Read .cursor/rules/ for project context: tech stack, coding standards, architectural patterns, and any estimation guidelines.
