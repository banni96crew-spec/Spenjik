...
name: scope-check
description: >-
  Analyze a feature or sprint for scope creep by comparing current scope against the original plan.
  Flags additions, quantifies bloat, and recommends cuts. Use when user says 'any scope creep', 'scope
  review', 'are we staying in scope'.
---
...
- Treat user-provided arguments as: `[feature-name or sprint-N]`.
...
**Argument:** `the first user-provided argument` — feature name, sprint number, or milestone name.
