...
description: >-
  Generates a structured playtest report template or analyzes existing playtest notes into a
  structured format. Use this to standardize playtest feedback collection and analysis.
---
...
- Treat user-provided arguments as: `[new|analyze path-to-notes] [--review full|lean|solo]`.
...
After categorising findings, spawn `creative-director` as a specialist review pass using gate **CD-PLAYTEST** (`.cursor/docs/director-gates.md`).
