...
name: changelog
description: >-
  Auto-generates a changelog from git commits, sprint data, and design documents. Produces both
  internal and player-facing versions.
---
...
- Treat user-provided arguments as: `[version|sprint-number]`.
