...
description: >-
  Generate design or architecture documents from existing implementation. Works backwards from
  codeprototypes to create missing planning docs.
---
...
- Treat user-provided arguments as: `<type> <path> (e.g., 'design src/gameplay/combat' or 'architecture src/core')`.
