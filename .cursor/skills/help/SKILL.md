...
name: help
description: >-
  Analyzes what is done and the user's query and offers advice on what to do next. Use if user says
  what should I do next or what do I do now or I'm stuck or I don't know what to do
---
...
- Treat user-provided arguments as: `[optional: what you just finished, e.g. 'finished design-review' or 'stuck on ADRs']`.
...
- Glob for and check if files matching the pattern exist
