...
74 Cursor Skills organized by phase. Cursor can apply skills automatically; type `/skill-name` in chat when you want an explicit skill.
...
| `/onboard` | Generate contextual onboarding document for a new contributor or Cursor agent |
