...
The following specialist roles are available for Cursor workflows. Use these identifiers as role prompts, Cursor Skill routing hints, or custom subagent names when `.cursor/agents/` definitions are added. When work spans multiple domains, the coordinator (usually `producer` or the domain lead) should delegate to the relevant specialists.

## Tier 1 -- Leadership Roles (High-Reasoning Model Tier)
...
## Tier 2 -- Department Lead Roles (Balanced Model Tier)
| Role | Domain | When to Use |
|------|--------|-------------|
...
## Tier 3 -- Specialist Roles (Balanced or Fast Model Tier)
| Role | Domain | Cursor model tier | When to Use |
|------|--------|-------------------|-------------|
...
| Role | Engine | Cursor model tier | When to Use |
| ---- | ---- | ------------------- | ---- |
...
| Role | Subsystem | Cursor model tier | When to Use |
| ---- | ---- | ------------------- | ---- |
